...
from aquaevitae_api.mail.messages import RECOMMENDATIONS_MESSAGE, RECOMMENDATIONS_SUBJECT
        ...
        if instance.user_email:
            asyncio.run(
                async_send_mail(
                    ...
                    message=RECOMMENDATIONS_MESSAGE % (instance.user_name, f"{settings.FRONTEND_URL}/products?form_id={instance.id}"),
