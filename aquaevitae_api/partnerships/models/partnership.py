...
class Partnership(BaseModel):
    ...
    company = models.ForeignKey(Company, null=True, blank=True, on_delete=models.DO_NOTHING, related_name='+')
    company_request = models.ForeignKey(CompanyRequest, null=True, blank=True, on_delete=models.DO_NOTHING)
